...
pubs_raw = load_json("./SNATest/sna_data","sna_valid_pub.json")
name_pubs1 = load_json("./SNATest/sna_data","sna_valid_example_evaluation_scratch.json")
...
dump_json(result, "genetest", "result_valid2.json",indent =4)
