...
#     save_model_name = "word2vec/Aword2vec.model"
    save_model_name = "word2vec/Aword2vec2.model"
...
pubs_raw = load_json("./SNATest/train","train_pub.json")
pubs_raw1 = load_json("./SNATest/sna_data","sna_valid_pub.json")
# pubs_raw2 = load_json("./SNATest/sna_test_data","test_pub_sna.json")
r = '[!“”"#$%&\'()*+,-./:;<=>?@[\\]^_`{|}~—～’]+'
...
model.save('word2vec/Aword2vec2.model')
